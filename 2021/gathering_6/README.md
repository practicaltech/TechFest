...
<ol type="a">
  ...
  <li>Navigate to the 'Sketch' tab and copy these lines into your code:</li>
   ...
   <li>Select the edit button to create a widget.</li>
              <p align="center"> 
                <img width="700" height="110" src="https://user-images.githubusercontent.com/52707386/125816554-2bed645b-b05f-47e8-bd4c-736b379ebc78.png"> 
                <br>
    ...
    <li>Select 'ADD' and then 'Push Button'</li>
     ...
     <li>Within the link variable menu, select your recently created variable and then select 'LINK VARIABLE.'</li>
              <p align="center"> 
                <img width="900" height="250" src="https://user-images.githubusercontent.com/52707386/125817259-cda297a5-696d-4d9b-9d3c-246b9357966b.png"> 
                <br>
                Link variables menu
                </br><br>
              </p>
